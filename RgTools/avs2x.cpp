...
extern "C" __declspec(dllexport) const char* __stdcall AvisynthPluginInit3(IScriptEnvironment* env, const AVS_Linkage* const vectors) {
    ...
    env->AddFunction("ForwardClense", "c[grey]b[planar]b[cache]i[planar]b", Create_ForwardClense, 0);
    env->AddFunction("BackwardClense", "c[grey]b[planar]b[cache]i[planar]b", Create_BackwardClense, 0);
